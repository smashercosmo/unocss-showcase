...
import type { PropsFromDescriptor, Tokens } from "../../../apps/example/src/types";
import type { Descriptor } from "../../../apps/example/src/descriptors";
...
describe("Types", () => {
  ...
  it("should use generate property value based on the `token` field", () => {
    ...
    expectTypeOf<{ padding?: Tokens["space"] }>().toEqualTypeOf<
      PropsFromDescriptor<typeof descriptor>
    >();
  });
  ...
  it("should generate type for multiple properties", () => {
    ...
    type ExpectedType = {
      margin?: Tokens["space"] | 0 | 1 | "auto";
      marginInline?: Tokens["space"] | 0 | 1 | "auto";
      marginBlock?: Tokens["space"] | 0 | 1 | "auto";
    };
